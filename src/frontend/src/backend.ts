...
export class Backend implements backendInterface {
    ...
    async getPreferences(arg0: string): Promise<Preferences | null> {
        if (this.processError) {
            try {
    ...
    async savePreferences(arg0: string, arg1: Preferences): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Preferences]): Preferences | null {
